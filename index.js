...
console.log('Task 1:', final2014[0]["Home Team Name"]);
...
function getYears(data, getFinalsCB) {
    const teamsInFinals = getFinalsCB(data)
    const years = teamsInFinals.map(function (item){
        return item.Year
    })
return years
}
...
//   const teamsInFinals = getFinals()
//   teamsInFinals.forEach(function(item){
